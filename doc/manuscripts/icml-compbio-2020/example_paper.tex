...
\icmltitlerunning{Submission and Formatting Instructions for ICML Workshop on Computational Biology (ICML WCB 2020)}

\begin{document}

\twocolumn[
\icmltitle{Submission and Formatting Instructions for
           the \\ ICML Workshop on Computational Biology (ICML WCB 2020)}
...
Conference on Machine Learning (ICML) Workshop of Computational Biology (WCB). Do not distribute.'' must be
modified to ``\textit{Proceedings of the
$\mathit{37}^{th}$ International Conference on Machine Learning Workshop of Computational Biology (WCB)},
Vienna, Austria, 2020.
