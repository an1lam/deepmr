...
def main(args):
    ...
    if args.mode == "train":
        ...
        train_data = load_binding_data(args.data_dir, train_chroms, args.binding_file, verbose=True)
        validation_data = load_binding_data(args.data_dir, args.val_chroms, args.binding_file)
        ...
        model, _, _ = create_and_train_model(
            train_dataset, validation_dataset, model, check_point_filename=model_file_path
        )
