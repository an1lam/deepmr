...
png(file.path("../../doc/manuscripts/deepmr_preprint/fig/", "suppfig_all_tfs_ces_kde.png"), width = 512, height = 320)
par(mar=c(5, 6, 5, 1)+.1)
...
ggsave(file.path("../../doc/manuscripts/deepmr_preprint/fig/", "fig3_bpnet_global_ces.png"))
```
